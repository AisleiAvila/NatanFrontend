...
import { DataService, Service, ServiceRequest } from '../../core/services/data.service';
...
export class RequestServiceComponent implements OnInit {
    ...
    if (this.isAllFormsValid()) {
      ...
      const requestData: Partial<ServiceRequest> = {
        ...
        clientInfo: {
          ...
          nif: this.clientInfoForm.value.includeNifInQuote ? this.clientInfoForm.value.nif : undefined
        }
      };
  ...
  private isAllFormsValid(): boolean {
    return this.serviceSelectionForm.valid && 
