  ...
  loadTranslations() {
    this.translations = {
      pt: {
        ...
        "hero.subtitle":
          "Plataforma completa para conectar clientes e prestadores de serviços de construção com qualidade e confiança.",
      ...
      en: {
        ...
        "hero.subtitle":
          "Complete platform to connect clients and construction service providers with quality and trust.",
...
// Initialize the app
window.natanApp = new NatanConstrutoraApp();
